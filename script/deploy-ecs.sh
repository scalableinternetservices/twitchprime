...
usage="Usage: deploy-ecs.sh [twitchprime-app-web|twitchprime-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/twitchprime:$2"
...
aws ecs update-service --cluster twitchprime \
  --no-cli-pager \
  --region "$ecs_region" \
