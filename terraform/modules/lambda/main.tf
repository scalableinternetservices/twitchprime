...
# Lambda URIs are "{+lambda}/{+function}" e.g. "twitchprime/ping".
# We also support path matching at the root e.g. "twitchprime" but these require definining separate "_root" terraform resources.
